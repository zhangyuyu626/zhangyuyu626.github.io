$(function () {
    ...
    function echart_1() {
        ...
        var data = [
            {value: 2767,name: 'total'},
            {value: 1976,name: 'Operators'},
            {value: 385,name: 'SG&A'},
            {value: 376,name: 'Engineers'}
        ];
        ...
        option = {
            ...
            legend: { //图例组件，颜色和名字
                ...
                icon: 'rect',
                data: ['Total', 'Operators', 'SG&A', 'Engineers'],
                textStyle: {
                    color: [],
                    fontStyle: 'normal',
                    fontFamily: '微软雅黑',
    ...
    function echart_2() {
        ...
        option = {
            ...
            yAxis: {
                type: 'category',
                data: ['Engineers', 'SG&A', 'Operators', 'Total'],
                axisTick : {show: true},
                axisLabel: { //调整x轴的lable
                    textStyle: {
                        color: '#fff',
            ...
            xAxis: [
                {
                    ...
                    axisLabel:{interval:0,textStyle:{color:'#ffffff',fontSize:12} },
                    axisTick : {show: false},
                    data:xAxisData,
                },
            ],
            yAxis: [
                {
                    ...
                    axisLabel:{textStyle:{color:'rgba(255, 255, 255, 0)',fontSize:12} },
                    axisLine: { show: true,lineStyle:{ color:'#2c3459'}},
                },
            ],
            series:serieData
            ...
            "yAxis": [
                {
                    ...
                    axisLine: {lineStyle: {color: 'rgba(255, 255, 67, 0)'}},//左线色
                ...
                },
                {
                    ...
                    axisLine: {lineStyle: {color: 'rgba(255, 67, 67, 0)'}},//右线色
